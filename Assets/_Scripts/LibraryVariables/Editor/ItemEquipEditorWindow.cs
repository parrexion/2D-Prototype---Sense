...
public class ItemEquipEditorWindow {
	...
	public ItemEquipEditorWindow(ScrObjLibraryVariable entries, ItemEquip container){
		itemLibrary = entries;
...
EditorGUIUtility.labelWidth = 150;
		...
		itemValues.sDefenseModifier = EditorGUILayout.IntField("Spirit Defense modifier", itemValues.sDefenseModifier);
